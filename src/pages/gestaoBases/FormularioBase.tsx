...
export const FormularioBase: React.FC = () => {
        ...
        .then((snapshot) => {
          if (snapshot.exists()) {
            ...
            if (baseData.responsaveis) {
              setResponsaveis(
                baseData.responsaveis.map((r: any) => ({
                  nome: r.nome || "",
                  telefone: r.telefone || "",
                  email: r.email || "",
                  cargo: r.cargo || "",
            ...
            if (baseData.contrato) {
              setContrato({
                ...
                modalidadePagamento:
                  baseData.contrato.modalidadePagamento || "mensal",
                diaVencimentoMensal:
                  baseData.contrato.diaVencimentoMensal || "10",
              });
            }
  ...
  const updateModeloContrato = (
    field: keyof ModeloContratoData,
    value: string
  ) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (responsaveisValidos.length === 0) {
      toast.validationError(
        "É necessário pelo menos um responsável com nome e telefone."
      );
      return;
    }
    ...
    try {
      ...
      if (limiteUsuarios.trim() && limiteUsuarios !== "0") {
        ...
        if (isNaN(limite) || limite <= 0) {
          toast.validationError(
            "Limite deve ser um número positivo ou vazio para ilimitado."
          );
          return;
        }
          ...
          <div className="flex items-center gap-4">
            ...
            {isEdicao && (
              <Badge variant="secondary">
                ID: {nextNumberId ? nextNumberId - 1 : "N/A"}
              </Badge>
            )}
          </div>
        </CardHeader>
            ...
            <div className="bg-white p-6 rounded-lg border">
              ...
              <div className="flex flex-wrap gap-6 p-4 bg-gray-50 rounded-lg mb-6">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="ativo" className="text-gray-800">
                    Base Ativa
                  </Label>
                </div>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg border">
              ...
              <div className="space-y-4">
                {responsaveis.map((responsavel, index) => (
                  <div
                    key={index}
                    className="p-4 border border-gray-300 rounded-lg space-y-4 bg-gray-50"
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor={`responsavel-nome-${index}`}>
                          Nome *
                        </Label>
                        <Input
                      ...
                      <div>
                        <Label htmlFor={`responsavel-cargo-${index}`}>
                          Cargo
                        </Label>
                        <Input
                          ...
                          onChange={(e) =>
                            updateResponsavel(index, "cargo", e.target.value)
                          }
                      ...
                      <div>
                        <Label htmlFor={`responsavel-email-${index}`}>
                          E-mail
                        </Label>
                        <Input
                      ...
                      <div className="flex flex-wrap gap-6 p-4 bg-white rounded-lg border border-gray-200">
                        <div className="flex items-center space-x-2">
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              updateResponsavel(index, "isFinanceiro", checked)
                            }
                          />
                          <Label
                        ...
                        <div className="flex items-center space-x-2">
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              updateResponsavel(index, "isSistema", checked)
                            }
                          />
                          <Label
                            htmlFor={`sistema-${index}`}
                            className="text-sm text-gray-800"
                          >
                        ...
                        <div className="flex items-center space-x-2">
                          <Switch
                            ...
                            onCheckedChange={(checked) =>
                              updateResponsavel(index, "isContato", checked)
                            }
                          />
                          <Label
                            htmlFor={`contato-${index}`}
                            className="text-sm text-gray-800"
                          >
                            Contato Principal
                          </Label>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateContrato("valorMensal", e.target.value)
                        }
                        placeholder="0,00"
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateContrato("dataInicio", e.target.value)
                      }
                      className="border-gray-300 hover:border-black focus:border-black"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateContrato("dataVencimento", e.target.value)
                      }
                      className="border-gray-300 hover:border-black focus:border-black"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateContrato("prazoMeses", e.target.value)
                      }
                      placeholder="12"
                      className="border-gray-300 hover:border-black focus:border-black"
                    />
                  ...
                  <div>
                    <Label htmlFor="modalidadePagamento">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updateContrato("modalidadePagamento", e.target.value)
                      }
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateContrato("diaVencimentoMensal", e.target.value)
                      }
                      placeholder="10"
                      className="border-gray-300 hover:border-black focus:border-black"
                    />
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      updateContrato("observacoes", e.target.value)
                    }
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateModeloContrato("templateTitle", e.target.value)
                    }
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      updateModeloContrato("templateContent", e.target.value)
                    }
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Use variáveis como [NOME_BASE], [CNPJ], [VALOR_MENSAL],
                    [DATA_INICIO] que serão substituídas automaticamente na
                    impressão.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white p-6 rounded-lg border">
              <div className="flex items-center justify-between mb-6 border-b pb-2">
                ...
                <Dialog
                  ...
                  onOpenChange={setModalAnotacaoAberto}
                >
