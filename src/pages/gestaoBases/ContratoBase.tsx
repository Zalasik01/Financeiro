...
export const ContratoBase: React.FC = () => {
  ...
  const downloadContrato = () => {
    ...
    try {
      ...
      contratoContent = contratoContent.replace(
        /\[NOME_BASE\]/g,
        base.name || "[NOME_BASE]"
      );
      contratoContent = contratoContent.replace(
      ...
      contratoContent = contratoContent.replace(
        /\[VALOR_MENSAL\]/g,
        base.contrato?.valorMensal
          ? formatCurrency(base.contrato.valorMensal)
          : "[VALOR_MENSAL]"
      );
      contratoContent = contratoContent.replace(
        /\[DATA_INICIO\]/g,
        base.contrato?.dataInicio
          ? formatDate(base.contrato.dataInicio)
          : "[DATA_INICIO]"
      );
      contratoContent = contratoContent.replace(
        /\[DATA_VENCIMENTO\]/g,
        base.contrato?.dataVencimento
          ? formatDate(base.contrato.dataVencimento)
          : "[DATA_VENCIMENTO]"
      );
      contratoContent = contratoContent.replace(
        /\[MODALIDADE_PAGAMENTO\]/g,
        base.contrato?.modalidadePagamento
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="font-semibold">
                        {base.contrato.prazoMeses
                          ? `${base.contrato.prazoMeses} meses`
                          : "N/A"}
                      </div>
                    </div>
                  </div>
